...
export function PermissionProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo(() => {
    ...
    return {
      ...
      canCreate: (module: string, resource: string) => isAdmin || hasPermission(`${module}.create_${resource}`) || hasPermission(`${module}.change_${resource}`),
      canEdit: (module: string, resource: string) => isAdmin || hasPermission(`${module}.edit_${resource}`) || hasPermission(`${module}.change_${resource}`),
